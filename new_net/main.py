...
from utils import simulate_step
import matplotlib.pyplot as plt
import time

chem_001 = Chemical(formula='001', initial_conc=0.004218, decay=2.721381, inflow=0)
chem_011 = Chemical(formula='011', initial_conc=0.155827, decay=3.738387, inflow=0)
chem_01 = Chemical(formula='01', initial_conc=0.045266, decay=0.873102, inflow=0)
chem_0011 = Chemical(formula='0011', initial_conc=0.669255, decay=3.171469, inflow=0.372868)
chem_000 = Chemical(formula='000', initial_conc=1.617242, decay=3.626139, inflow=0)
chem_0 = Chemical(formula='0', initial_conc=4.278178, decay=4.204123, inflow=0)
chem_00 = Chemical(formula='00', initial_conc=0.866823, decay=1.552885, inflow=0)
chem_0001 = Chemical(formula='0001', initial_conc=0.628683, decay=1.969112, inflow=0)
chem_1 = Chemical(formula='1', initial_conc=1.349662, decay=5.946280, inflow=0)
chem_0111 = Chemical(formula='0111', initial_conc=0.283833, decay=0.047865, inflow=0)
chem_11 = Chemical(formula='11', initial_conc=0.255579, decay=3.106958, inflow=0)
chem_111 = Chemical(formula='111', initial_conc=1.008871, decay=0.217617, inflow=0)
...
network = Network(chemicals, reactions)
